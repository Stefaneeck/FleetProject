...
namespace BlazorTest.Pages
{
    ...
    {
        //needed to be able to use employeeid as parameter is the component razor page (@page "/driverdetail/{EmployeeId}")
        [Parameter]
        ...
        protected override Task OnInitializedAsync()
        {
            ...
            Employee = Employees.FirstOrDefault(employee => employee.EmployeeId == int.Parse(EmployeeId));
